...
uint16_t stop_time_to_current=299;
...
int16_t *shoot_control_loop(void)
{
    ...
    if(stop_time <=600) stop_time_to_current = stop_time;
    if(shoot_control.dual_mode==LEFT)
    {
        shoot_control.given_current[1]=2100+(stop_time_to_current-300)*5.5;
    }
...
fp32 fric_18 = FRIC_18;
fp32 fric_15 = FRIC_15;
int8_t low_speed_flag = 0;  
static void shoot_feedback_update(void)
{
